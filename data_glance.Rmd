...
```{r}
tempData <- mice(listings_numerical_clean,m=5,maxit=50,meth='polyreg',seed=6210) #citation, the link is at the end of the document # hasn't work yet  
summary(tempData)
```


```{r}
listings_numerical_clean_head <- listings_numerical_clean %>%
  head(5000)
