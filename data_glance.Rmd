...
________________
Individual Residual and MSE, CI,PI and Conditions for ChaoYang Model, 
```{r}

#Random Selecting Sample 
ChaoYang_Sample<-sample_n(completed_listings_chaoyang, 8092)
...
```{r}
#Mean and median residual of the first 1000 listings in ChaoYang
#abs(resid(mod_chaoyang_Sample))
mean(abs(resid(mod_chaoyang_Sample)))
